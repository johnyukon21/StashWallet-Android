...
public class ScanActivity extends LoggedActivity implements TextureView.SurfaceTextureListener, View.OnClickListener,
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mAddressEditText.setHint(R.string.id_enter_an_address);
    ...
    private void onTransaction(final String scanned) {
        ...
        disposable = Observable.just(Session.getSession())
                     .observeOn(Schedulers.computation())
                     .map((session) -> {
                         final ObjectNode transactionRaw = Session.getSession().createTransactionFromUri(null, scanned, subaccount);
